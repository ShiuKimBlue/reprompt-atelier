...
- 提供准确检索信息能显著减少模型错误，达到 94% 的准确率
- 当文档中的错误信息增多且 LLM 的内部先验较弱时，LLM 更倾向于重复错误信息
- 当 LLM 拥有较强的先验时，对错误信息的抵抗力更强
- 修改后的信息与模型先验的差异越大，模型选择这种信息的可能性就越小
...
- [Wu et al. (2024)](https://arxiv.org/abs/2404.10198)
