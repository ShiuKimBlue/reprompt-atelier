...
最近，OpenAI发布了GPT-4，这是一个大型的多模态模型（multimodal model），可以接受图像和文本输入并输出文本。它在各种专业和学术基准测试中实现了人类水平的表现。

以下是一系列考试的详细结果：

![— GPT-4 考试成绩](/images/grimoire/gpt4-1.png)

以下是学术基准测试的详细结果：

![— GPT-4 学术基准测试](/images/grimoire/gpt4-2.png)

GPT-4在模拟律师考试中获得了一个将其排在前10%的得分。它在各种困难的基准测试中也取得了令人印象深刻的成绩，如MMLU和HellaSwag。

OpenAI声称，GPT-4通过他们的对抗性测试计划和ChatGPT的经验得到了改进，从而在事实性、可控性和更好的对齐（alignment）方面取得了更好的结果。
...
![— GPT-4 视觉输入示例（图表）](/images/grimoire/gpt4-3.png)
...
![— OpenAI Playground 快照](/images/grimoire/gpt4-4.png)
...
![— TruthfulQA 基准测试结果](/images/grimoire/gpt4-5.png)

请查看以下失败示例：

![— GPT-4 失败示例](/images/grimoire/gpt4-6.png)

答案应该是"Elvis Presley"。这突显了这些模型在某些用例中可能会很脆弱。将GPT-4与其他外部知识源相结合以提高此类情况的准确性，甚至使用我们在此处学到的一些提示工程技术，如上下文学习（in-context learning）或思维链提示（chain-of-thought prompting），以改善结果将是有趣的尝试。

让我们试一试。我们在提示中添加了其他说明，并添加了"逐步思考"的内容。这是结果：

![— 使用 CoT 提示的改进尝试](/images/grimoire/gpt4-7.png)
...
![— 使用系统消息和温度调整](/images/grimoire/gpt4-8.png)
