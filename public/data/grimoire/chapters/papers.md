...
以下是关于提示工程的最新论文（按发布日期排序）。我们每天更新，新论文不断涌现。
...
- [Pre-train, Prompt, and Predict: A Systematic Survey of Prompting Methods in NLP](https://arxiv.org/abs/2107.13586) | Jul 2021

## 方法

- [Enhancing Zero-Shot Chain-of-Thought Reasoning through Logic](https://arxiv.org/abs/2309.13339) | Feb 2024
...
- [More than you've asked for: A Comprehensive Analysis of Novel Prompt Injection Threats to Application-Integrated LLMs](https://arxiv.org/abs/2302.12173) | Feb 2023
...
- [A-la-carte Prompt Tuning (APT): Combining Distinct Data Via Composable Prompting](https://arxiv.org/abs/2302.07994) | Feb 2023
...
- [MRKL Systems: A modular, neuro-symbolic architecture that combines LLMs, external knowledge sources and discrete reasoning](https://arxiv.org/abs/2205.00445) | May 2022
- [PPT: Pre-trained Prompt Tuning for Few-shot Learning](https://aclanthology.org/2022.acl-long.576/) | May 2022
...
- [AI Chains: Transparent and Controllable Human-AI Interaction by Chaining LLM Prompts](https://arxiv.org/abs/2110.01691) | Oct 2021
...
- [How Can We Know What Language Models Know?](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00324/96460/) | July 2020
...
- [Linguistically Informed ChatGPT Prompts to Enhance Japanese-Chinese Machine Translation](https://arxiv.org/abs/2303.15587) | March 2023
...
- [Can GPT Pass Assessments in Higher Education Programming Courses?](https://arxiv.org/abs/2303.09325) | Mar 2023
- [SelfCheckGPT: Zero-Resource Black-Box Hallucination Detection for Generative LLMs](https://arxiv.org/abs/2303.08896) | Mar 2023
...
- [Choice Over Control: How Users Write with LLMs using Diegetic and Non-Diegetic Prompting](https://arxiv.org/abs/2303.03199) | March 2023
...
- [Check Your Facts and Try Again: Improving LLMs with External Knowledge and Automated Feedback](https://arxiv.org/abs/2302.12813) | Feb 2023
- [How Generative AI models such as ChatGPT can be (Mis)Used in SPC Practice, Education, and Research?](https://arxiv.org/abs/2302.10916) | Feb 2023
